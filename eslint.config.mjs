...
export default [
   ...
   // Prettier integration
   {
      ...
      rules: {
         ...
         //below code  shows Prettier issues as ESLint errors
         'prettier/prettier': ['error', { tabWidth: 3 }], // Customize Prettier rule behavior
      },
   },
   // Custom rules for all files
   {
      rules: {
         ...
         'linebreak-style': ['error', 'unix'], // Enforce LF line endingss
      },
   },
];
